...
class AWPollsPagingSource(
...
) : PagingSource<Int, AWPoll>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, AWPoll> {
        return try {
    ...
    override fun getRefreshKey(state: PagingState<Int, AWPoll>): Int? {
